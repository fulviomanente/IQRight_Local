...
if os.getenv('LOCAL', None) == 'TRUE':
    ...
    LORASERVICE_LOG_PATH = './log/Scanner.log'
    HOME_DIR = '.'
else:
    LORASERVICE_PATH = '/home/iqright/data'
    LORASERVICE_LOG_PATH = '/home/iqright/log/Scanner.log'
...
LORA_NODE_ID = int(os.getenv('LORA_NODE_ID', '102'))  # 100-199 for scanners
...
BEACON_LOCATIONS = [
    ...
    {"idBeacon": 103, "beacon": "QR Reader", "location": "Gym Side"},
