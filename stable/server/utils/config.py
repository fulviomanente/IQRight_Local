...
LOOKUP_TIMEOUT = float(os.getenv('LOOKUP_TIMEOUT', '2.0'))  # Overall timeout for getInfo()
...
RFM9X_FREQUENCE = LORA_FREQUENCY
RFM9X_TX_POWER = LORA_TX_POWER
RFM9X_NODE = LORA_NODE_ID
RFM9X_ACK_DELAY = 0.1
RFM9X_SEND_DELAY = 0.3
RMF9X_POOLING = 0.9

#RESTRICTION FOR GRADES
...
IDFACILITY = 1
BEACON_LOCATIONS = [{"beacon": 102, "device": "QR Reader", "location": "Gym Side"},
    {"beacon": 103, "device": "QR Reader", "location": "Gym Side"},
    {"beacon" : 3, "device": "BLE Reader","location": "Main Entrance"}]
